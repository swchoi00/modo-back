...
//		 세션 비활성화
		...
		http.authorizeRequests().antMatchers(HttpMethod.POST, "/**", "/login", "/oauth/kakao/", "/oauth/google/", "/oauth/naver/", "/oauth/join/").permitAll()
	...
	public CorsConfigurationSource configurationSource() {
		...
		config.addAllowedOrigin("https://modo-2024.web.app");
		config.addAllowedOrigin("https://modo2024.site");
