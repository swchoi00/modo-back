...
//	@JsonFormat(pattern="yyyy-MM-dd")
	...
	private List<Long> joinedMember;

	@JsonProperty("moim_id")
	public Long getMoimId() {
		return moim != null ? moim.getId() : null;
	}
...
//	private MoimMember members; // MoimMember 참조
    ...
    public String toString() {
        return "MoimSchedule{" +
                ...
                ", moimSchedulePhotoUrl='" + moimSchedulePhotoUrl + '\'' +
                ", moimId=" + getMoimId() + // moim_id 포함
                '}';
    }
