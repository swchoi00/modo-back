...
public class MoimScheduleReplyController {
	...
	@DeleteMapping("/moimScheduleReply/{rno}")
	public ResponseEntity<?> deleteMoimScheduleReply(@PathVariable Long rno) {
		
		moimScheduleReplyService.deleteScheduleReply(rno);
